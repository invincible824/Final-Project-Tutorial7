...
function onRenderCallback(id, // the "id" prop of the Profiler tree that has just committed
...
function PostRow(props) {
  ...
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("span", null, "Movie name: ", similar.movietitle, " "), /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("span", null, "Language: ", similar.language, " "), /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("span", null, "country: ", similar.country, " "), /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("span", null, "Genre: ", similar.genre, " "), /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("span", null, "Job Discription: ", similar.JD, " "), /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("br", null));
}

function Posts(props) {
  const similars = props.similars.map(similar => /*#__PURE__*/React.createElement(PostRow, {
    key: similar.id,
    similar: similar
  }));
...
function SimilarRow(props) {
  const similar = props.similar;
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("span", null, "Title: ", similar.title, " "), /*#__PURE__*/React.createElement("span", null, "Year: ", similar.year, " "), /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("img", {
    width: 400,
    height: 600,
    src: similar.image
  }));
...
function Similars(props) {
  const similars = props.similars.map(similar => /*#__PURE__*/React.createElement(SimilarRow, {
    key: similar.id,
    similar: similar
  }));
  return /*#__PURE__*/React.createElement("div", null, similars);
}
...
class HomePage extends React.Component {
  ...
  async loadData() {
    ...
    if (data) {
      ...
      console.log(data[0]); //this.setState({ issues: data.issueList,
      //availableSlots: 25 - data.issueList.length});
    }
  }
  ...
  async createIssue(issue) {
    ...
    if (data) {
      this.loadData(); //this.checkUsername(issue.id)
  ...
  render() {
    ...
    MKB = /*#__PURE__*/React.createElement(ButtonRegister, {
      onClick: this.handleRegister,
      isShow: !this.state.isAtHome
    });
    DSB = /*#__PURE__*/React.createElement(ButtonLogin, {
      onClick: this.handleLogin,
      isShow: !this.state.isAtHome
    });
    MDB = /*#__PURE__*/React.createElement(ButtonPost, {
      onClick: this.handlePost,
      isShow: !this.state.isAtHome
    });
    const BSP = /*#__PURE__*/React.createElement(ButtonShowpost, {
      onClick: this.handleShowpost,
      isShow: !this.state.isAtHome
    });
    const BSM = /*#__PURE__*/React.createElement(ButtonSearchmovie, {
    ...
    const SM = /*#__PURE__*/React.createElement(ShowMovie, {
      movie_detail: this.state.movie_detail,
      similars: this.state.similars,
      isShow: !this.state.isAtSearch
    });
    const register = /*#__PURE__*/React.createElement(Register, {
      createIssue: this.createIssue,
      handleSubmitSuccess: this.handleSubmitSuccess,
      isSubmitSuccess: this.state.isSubmitSuccess,
      isShow: !this.state.isAtRegister
    });
    const login = /*#__PURE__*/React.createElement(Login, {
      loginsubmit: this.loginsubmit,
      handleSubmitSuccess: this.handleSubmitSuccess,
      isSubmitSuccess: this.state.isSubmitSuccess,
      isShow: !this.state.isAtLogin
    });
    const postjob = /*#__PURE__*/React.createElement(Postjob, {
      postjob: this.postjob,
      currentuser: this.state.currentuser,
      isShow: !this.state.isAtPost,
      handleSubmitSuccess: this.handleSubmitSuccess,
      isSubmitSuccess: this.state.isSubmitSuccess
    });
    const showpost = /*#__PURE__*/React.createElement(ShowPost, {
      showpost: this.showpost,
      isShow: !this.state.isAtShowpost
    });
    const posts = /*#__PURE__*/React.createElement(Posts, {
      similars: this.state.postdata,
      isShow: !this.state.isAtShowpost
    });
    return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h1", null, " For Filmmakers "), /*#__PURE__*/React.createElement("p", null, " Current User:   ", /*#__PURE__*/React.createElement("span", null, this.state.currentuser), " "), BHPB, MKB, DSB, MDB, BSP, BSM, login, postjob, showpost, isstable, posts, /*#__PURE__*/React.createElement(SearchMovie, {
      updateMovieDetail: this.updateMovieDetail,
      isShow: !this.state.isAtSearch
    }), SM, register, /*#__PURE__*/React.createElement("hr", null));
  }
...
class SearchMovie extends React.Component {
  ...
  async searchmovie() {
    ...
    const {
      Search = []
    } = await res.json(); //console.log(Search[0]['imdbID'])

    const imdbid = Search[0]['imdbID']; //http://www.omdbapi.com/?apikey=8d876c08&s=avengers
    ...
    console.log(url); //const url = http://www.omdbapi.com/?apikey=8d876c08&s=avengers
    //const url = https://imdb-api.com/en/API/Title/k_h5qo5093/tt0110413

    const req = await fetch(url);
    const moviedata = await req.json();
    this.props.updateMovieDetail(moviedata); //console.log(req)
  ...
  render() {
    return (
      ...
      React.createElement("div", {
        hidden: this.props.isShow
      }, /*#__PURE__*/React.createElement("h2", null, " input movie "), /*#__PURE__*/React.createElement("span", null, " Input Movie name "), /*#__PURE__*/React.createElement("input", {
        type: "Name",
...
class ShowMovie extends React.Component {
  ...
  render() {
    const data = this.props.movie_detail; //console.log('test_show_movie');
    //console.log(data);
    ...
    return (
      ...
      React.createElement("div", {
        hidden: this.props.isShow
      }, /*#__PURE__*/React.createElement("h2", null, " show movie "), /*#__PURE__*/React.createElement("span", null, " Title: ", this.title, " "), /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("a", {
        href: director_herf
      }, " ", this.directors, " "), /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("span", null, " Year: ", this.year, " "), /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("span", null, " Genres: ", this.genres, " "), /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("span", null, " Directors: ", this.directors, " "), /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("span", null, " Stars: ", this.stars, " "), /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("span", null, " Languages: ", this.languages, " "), /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("span", null, " Countries: ", this.countries, " "), /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("span", null, " Keywords: ", this.keywords, " "), /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("span", null, " Writer(s): ", this.writers, " "), /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("img", {
        width: 800,
        height: 1200,
        src: this.image
      }), /*#__PURE__*/React.createElement("h3", null, " similar movies "), /*#__PURE__*/React.createElement(Similars, {
...
class Register extends React.Component {
  ...
  render() {
    return /*#__PURE__*/React.createElement("div", {
      hidden: this.props.isShow
    }, /*#__PURE__*/React.createElement("span", null, " Input Your UserName "), /*#__PURE__*/React.createElement("input", {
      type: "Name",
      name: "Input your Username",
      ref: input => this.username = input
    }), /*#__PURE__*/React.createElement("span", null, " Input Your Password "), /*#__PURE__*/React.createElement("input", {
      type: "Password",
...
class Postjob extends React.Component {
  ...
  post() {
    ...
    const jd = this.jd.value.trim(); //if this.props.currentuser = ''
  ...
  render() {
    return /*#__PURE__*/React.createElement("div", {
      hidden: this.props.isShow
    }, /*#__PURE__*/React.createElement("h2", null, " Post A Job "), /*#__PURE__*/React.createElement("span", null, " Input Your Movie Name "), /*#__PURE__*/React.createElement("input", {
      type: "moviename",
      name: "Input your Username",
      ref: input => this.moviename = input
    }), /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("span", null, " Input Your Movie Language "), /*#__PURE__*/React.createElement("input", {
      type: "movielanguage",
      ref: input => this.movielanguage = input
    }), /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("span", null, " Input Your Movie genre "), /*#__PURE__*/React.createElement("input", {
      type: "genre",
      name: "Input your Username",
      ref: input => this.genre = input
    }), /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("span", null, " Input Your Country "), /*#__PURE__*/React.createElement("input", {
      type: "country",
      name: "Input your Username",
      ref: input => this.country = input
    }), /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("span", null, " Input Your Job Description "), /*#__PURE__*/React.createElement("input", {
      type: "jd",
      name: "Input your Username",
      ref: input => this.jd = input
    }), /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("button", {
      onClick: this.post.bind(this)
    }, "Post A Job "), /*#__PURE__*/React.createElement("p", {
      hidden: !this.props.isSubmitSuccess,
      style: {
        backgroundColor: 'green'
      }
...
class ShowPost extends React.Component {
  ...
  render() {
    return /*#__PURE__*/React.createElement("div", {
      hidden: this.props.isShow
    }, /*#__PURE__*/React.createElement("h2", null, " Show Job Posted "), /*#__PURE__*/React.createElement("button", {
      onClick: this.displaypost.bind(this)
    }, "Show All Jobs Posted "), /*#__PURE__*/React.createElement("p", {
      hidden: !this.props.isSubmitSuccess,
      style: {
        backgroundColor: 'green'
      }
